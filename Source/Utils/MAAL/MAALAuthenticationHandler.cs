...
/// <inheritdoc />
internal sealed class MAALAuthenticationHandler : OAuthHandler<MAALAuthenticationOptions>
{
	/// <inheritdoc />
	public MAALAuthenticationHandler(IOptionsMonitor<MAALAuthenticationOptions> options,
